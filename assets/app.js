const translations = {
  ru: {
    ...
    aboutTitle: 'Офисный домовой и тот самый инженер без которого ваш бизнес просто встает через пару дней.',
    aboutText: 'Я молодой Инженер, системный администратор. приходя в компанию я сразу беру под контроль серверы, сети и всю инфраструктуру, чтобы уничтожить хаос и собрать доступы в единую защищенную базу.Меня жутко утомляет экономия на критически важных узлах и сборка систем на коленке. Поверьте я знаю как сэкономить ваши деньги без ущерба для качества, ведь мне самому выгодно чтобы всё работало идеально. Я ценю честность, полную конфиденциальность и отсутствие эйджизма. Вы не обязаны быть техническим гуру, а я в ответ жду уважения к своему труду. Если меня не душить микроменеджментом, я становлюсь максимально проактивным и сам приношу идеи для бизнеса. А в свободное время с удовольствием поговорю с вами про игры, кино или философию.',
    ...
    casesEyebrow: 'Кейсы', casesTitle: 'Мой опыт в реальных задачах', casesText: 'Показываю на понятных историях как именно я решаю проблемы бизнеса и стабилизирую работу офиса.',
